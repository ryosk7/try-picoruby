...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_picorb_init')) {
        Object.defineProperty(Module['ready'], '_picorb_init', { configurable: true, get: function() { abort('You are getting _picorb_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_picorb_init', { configurable: true, set: function() { abort('You are setting _picorb_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_picorb_create_task')) {
        Object.defineProperty(Module['ready'], '_picorb_create_task', { configurable: true, get: function() { abort('You are getting _picorb_create_task on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_picorb_create_task', { configurable: true, set: function() { abort('You are setting _picorb_create_task on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_mrbc_tick')) {
        Object.defineProperty(Module['ready'], '_mrbc_tick', { configurable: true, get: function() { abort('You are getting _mrbc_tick on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_mrbc_tick', { configurable: true, set: function() { abort('You are setting _mrbc_tick on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_mrbc_run_step')) {
        Object.defineProperty(Module['ready'], '_mrbc_run_step', { configurable: true, get: function() { abort('You are getting _mrbc_run_step on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_mrbc_run_step', { configurable: true, set: function() { abort('You are setting _mrbc_run_step on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_call_ruby_callback')) {
        Object.defineProperty(Module['ready'], '_call_ruby_callback', { configurable: true, get: function() { abort('You are getting _call_ruby_callback on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_call_ruby_callback', { configurable: true, set: function() { abort('You are setting _call_ruby_callback on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_resume_promise_task')) {
        Object.defineProperty(Module['ready'], '_resume_promise_task', { configurable: true, get: function() { abort('You are getting _resume_promise_task on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_resume_promise_task', { configurable: true, set: function() { abort('You are setting _resume_promise_task on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_resume_binary_task')) {
        Object.defineProperty(Module['ready'], '_resume_binary_task', { configurable: true, get: function() { abort('You are getting _resume_binary_task on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_resume_binary_task', { configurable: true, set: function() { abort('You are setting _resume_binary_task on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'picoruby.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('picoruby.wasm', import.meta.url).toString();
}
...
function call_method(ref_id,method,arg){ try { const obj = window.picorubyRefs[ref_id]; const func = obj[UTF8ToString(method)]; const result = func.call(obj, UTF8ToString(arg)); const newRefId = window.picorubyRefs.length; window.picorubyRefs.push(result); return newRefId; } catch(e) { console.error(e); return -1; } }
function call_method_str(ref_id,method,arg1,arg2){ try { const obj = window.picorubyRefs[ref_id]; const func = obj[UTF8ToString(method)]; const result = func.call(obj, UTF8ToString(arg1), UTF8ToString(arg2)); const newRefId = window.picorubyRefs.length; window.picorubyRefs.push(result); return newRefId; } catch(e) { console.error(e); return -1; } }
function call_method_with_ref(ref_id,method,arg_ref_id){ try { const obj = window.picorubyRefs[ref_id]; const methodName = UTF8ToString(method); const func = obj[methodName]; const argObj = window.picorubyRefs[arg_ref_id]; const result = func.call(obj, argObj); const newRefId = window.picorubyRefs.length; window.picorubyRefs.push(result); return newRefId; } catch(e) { console.error(e); return -1; } }
function call_method_with_ref_ref(ref_id,method,arg_ref_1_id,arg_ref_2_id){ try { const obj = window.picorubyRefs[ref_id]; const methodName = UTF8ToString(method); const func = obj[methodName]; const argObj1 = window.picorubyRefs[arg_ref_1_id]; const argObj2 = window.picorubyRefs[arg_ref_2_id]; const result = func.call(obj, argObj1, argObj2); const newRefId = window.picorubyRefs.length; window.picorubyRefs.push(result); return newRefId; } catch(e) { console.error(e); return -1; } }
function get_element(ref_id,index){ try { const nodeList = window.picorubyRefs[ref_id]; const element = nodeList[index]; if (element === undefined) { return -1; } const newRefId = window.picorubyRefs.push(element) - 1; return newRefId; } catch(e) { return -1; } }
function get_length(ref_id){ try { const obj = window.picorubyRefs[ref_id]; return obj.length || 0; } catch(e) { return -1; } }
function get_property(ref_id,key){ try { const obj = window.picorubyRefs[ref_id]; const value = obj[UTF8ToString(key)]; const newRefId = window.picorubyRefs.length; window.picorubyRefs.push(value); return newRefId; } catch(e) { return -1; } }
function init_js_refs(){ if (typeof globalThis.picorubyRefs === 'undefined') { globalThis.picorubyRefs = []; globalThis.picorubyRefs.push(window); } }
...
function is_array_like(ref_id){ const obj = window.picorubyRefs[ref_id]; return obj instanceof NodeList || obj instanceof HTMLCollection || (typeof obj === 'object' && obj !== null && 'length' in obj && typeof obj.length === 'number'); }
function js_add_event_listener(ref_id,callback_id,event_type){ const target = globalThis.picorubyRefs[ref_id]; const type = UTF8ToString(event_type); target.addEventListener(type, (event) => { const eventRefId = globalThis.picorubyRefs.push(event) - 1; ccall( 'call_ruby_callback', 'void', ['number', 'number'], [callback_id, eventRefId] ); }); }
...
function setup_binary_handler(ref_id,tcb,callback_id){ const response = window.picorubyRefs[ref_id]; if (!response || typeof response.arrayBuffer !== 'function') { console.error('Invalid response object:', response); return 0; } response.arrayBuffer().then(arrayBuffer => { const uint8Array = new Uint8Array(arrayBuffer); const ptr = _malloc(uint8Array.length); const heapBytes = new Uint8Array(HEAPU8.buffer, ptr, uint8Array.length); heapBytes.set(uint8Array); ccall( 'resume_binary_task', 'void', ['number', 'number', 'number', 'number'], [tcb, callback_id, ptr, uint8Array.length] ); }).catch(error => { console.error('Error in arrayBuffer processing:', error); }); return 0; }
function setup_promise_handler(promise_id,callback_id,tcb){ const promise = globalThis.picorubyRefs[promise_id]; promise.then( (result) => { const resultId = globalThis.picorubyRefs.length; globalThis.picorubyRefs.push(result); ccall( 'resume_promise_task', 'void', ['number', 'number', 'number'], [tcb, callback_id, resultId] ); } ); }
...
var asmLibraryArg = {
  ...
  "call_method_str": call_method_str,
  "call_method_with_ref": call_method_with_ref,
  "call_method_with_ref_ref": call_method_with_ref_ref,
  ...
  "init_js_refs": init_js_refs,
  "init_js_type_offsets": init_js_type_offsets,
  "invoke_iiii": invoke_iiii,
  "invoke_vi": invoke_vi,
  "invoke_viii": invoke_viii,
  "is_array_like": is_array_like,
  "js_add_event_listener": js_add_event_listener,
  "js_get_type_info": js_get_type_info,
  "proc_exit": _proc_exit,
  "setTempRet0": _setTempRet0,
  "set_property": set_property,
  "setup_binary_handler": setup_binary_handler,
  "setup_promise_handler": setup_promise_handler,
  "time": _time
};
var asm = createWasm();
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _mrbc_tick = Module["_mrbc_tick"] = createExportWrapper("mrbc_tick");

/** @type {function(...*):?} */
var _mrbc_run_step = Module["_mrbc_run_step"] = createExportWrapper("mrbc_run_step");

/** @type {function(...*):?} */
var _call_ruby_callback = Module["_call_ruby_callback"] = createExportWrapper("call_ruby_callback");

/** @type {function(...*):?} */
var _resume_promise_task = Module["_resume_promise_task"] = createExportWrapper("resume_promise_task");

/** @type {function(...*):?} */
var _resume_binary_task = Module["_resume_binary_task"] = createExportWrapper("resume_binary_task");

/** @type {function(...*):?} */
var _picorb_init = Module["_picorb_init"] = createExportWrapper("picorb_init");

/** @type {function(...*):?} */
var _picorb_create_task = Module["_picorb_create_task"] = createExportWrapper("picorb_create_task");
